...
class Game:
    ...
    def __init__(self, file_path: str, end_of_game_event: Callable,
                 allowed_mistakes: int):  # третье - уведомляет о завершении игры
        ...
        self.__fill_in_questions(file_path,
                                 self.__questions)  # тут  чтение файлов, но так не делать, ибо чтение мб длительным
